...
VERSION = "final_031811_simple_reproducer_v20260428"
...
def validate_against_train_max(report: pd.DataFrame, final_label: str = "final_031811_simple_reproducer") -> None:
...
def main(
    ...
    final_path = submissions_dir / "submission_final_031811_simple_reproducer_v20260428.csv"
    ...
    summary_rows.extend(summarize(final, test_rows, "final_031811_simple_reproducer", priors))
    ...
    source_summary = {
        ...
        "note": (
            "This simple reproducer uses prior Kaggle outputs to reproduce the public-LB 0.31811 strategy: preserve Lynx, Salamander, "
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simple previous-output reproducer for the 0.31811 AnimalCLEF2026 species-wise final fusion.")
